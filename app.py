...
import matplotlib
matplotlib.use('Agg')          # Wajib untuk Vercel (Non-GUI)
...
# Global variables untuk menyimpan data model
model = None
X_all, y_all, y_pred_all, mae, mse, r2 = [None] * 6

def load_assets():
    """Fungsi untuk memuat model dan data secara aman"""
...
def plot_comparison():
    # Pastikan data terload sebelum plotting
